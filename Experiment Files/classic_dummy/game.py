...
POSITION_X_HISTORY = list() # a history of the player's x positions of the last POSITION_HISTORY_LENGTH frames (only used in enhanced nox)
...
def loadPaths(path):
	...
	LEVEL_PREFIX = paths[0] # default: r"levels_randomized_gfx/"
...
def init():
	...
	pg.key.set_repeat(1, tmp) # TODO check again
...
def init_world(worldpath):
	...
	# TODO check behavior in case of not "blocksize divides resolution"
...
def generateAIParams():
	...
	# currently only used for enhanced nox
