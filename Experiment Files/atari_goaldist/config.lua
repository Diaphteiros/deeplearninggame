...
IMG_DIMENSIONS = {1, 84, 84} -- screenshots will be resized to this immediately
IMG_DIMENSIONS_Q_HISTORY = {1, 84, 84} -- size of images fed into Q (action history)
IMG_DIMENSIONS_Q_LAST = IMG_DIMENSIONS_Q_HISTORY -- size of the last state's image fed into Q
