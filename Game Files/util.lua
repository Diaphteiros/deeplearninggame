...
function util.getCurrentScore()
    return aiconnector.PARAMS.score
end

-- CHANGED: returns total number of deaths
function util.getDeathCount()
	return aiconnector.PARAMS.deathCount
end

-- CHANGED: returns total number of levels beaten
function util.getLevelBeatenCount()
	return aiconnector.PARAMS.levelBeatenCount
end
...
function util.getPlayerX()
    return aiconnector.PARAMS.x
end

-- returns the distance to the goal
function util.getGoalDistance()
    return aiconnector.PARAMS.xDistanceToGoal
end
...
--[[ CHANGED: this can't be done from LUA right now
...
function util.getScreen()
    ...
    --gui.screenshot(fp) -- screenshot is taken from python game
